...
Emphasis.prototype = subclass(Node, {
    ...
    toHTML: function() {
        if (this.depth == 1) {
            return '<emph>' + this.content.toHTML() + '</emph>';
        } else if (this.depth == 2) {
            return '<strong>' + this.content.toHTML() + '</strong>';
        } else if (this.depth == 3) {
            return '<strong><emph>' + this.content.toHTML() + '</emph></strong>';
        }
    },
...
Embed.prototype = subclass(Node, {
    ...
    transform: function(object, cb) {
        ...
        args.push.apply(args, [this.url, this.title, this.alt, _.bind(function(err, content) {
